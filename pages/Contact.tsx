      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 bg-secondary/80 backdrop-blur-sm p-6 md:p-12 rounded-3xl border border-white/5 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col justify-center relative z-10">
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-start gap-5 group">
                    ...
                    <div>
                        ...
                        <a href="mailto:hello@neuralmethod.com" className="text-white hover:text-accent transition-colors text-lg font-medium block break-all">
                ...
                <div className="flex items-start gap-5 group">
                    ...
                    <div>
                        <p className="text-xs text-neutral-light/50 font-bold uppercase tracking-wider mb-1">Location</p>
            ...
            <div className="pt-8 mt-12 border-t border-white/10 flex gap-6">
                <a href="https://www.linkedin.com/company/109965142/admin/dashboard/" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://x.com/NeuralMethod" target="_blank" rel="noopener noreferrer"
                   className="w-10 h-10 rounded-full border border-secondary bg-primary flex items-center justify-center text-neutral-light hover:border-accent hover:text-accent hover:shadow-[0_0_15px_rgba(56,182,255,0.3)] transition-all">
                ...
                <a href="https://www.instagram.com/neuralmethod.ai/" target="_blank" rel="noopener noreferrer"
                   className="w-10 h-10 rounded-full border border-secondary bg-primary flex items-center justify-center text-neutral-light hover:border-accent hover:text-accent hover:shadow-[0_0_15px_rgba(56,182,255,0.3)] transition-all">
                    <Instagram className="w-5 h-5" />
                </a>

                <a href="https://www.facebook.com/profile.php?id=61583954945549" target="_blank" rel="noopener noreferrer"
                   className="w-10 h-10 rounded-full border border-secondary bg-primary flex items-center justify-center text-neutral-light hover:border-accent hover:text-accent hover:shadow-[0_0_15px_rgba(56,182,255,0.3)] transition-all">
        ...
        <div className="bg-primary/50 p-6 md:p-8 rounded-2xl border border-white/5 relative z-10">
            ...
            {submitStatus === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {/* Submit Button */}
                  <Button type="submit" fullWidth disabled={isSubmitting} className="group">
                    {isSubmitting ? (
