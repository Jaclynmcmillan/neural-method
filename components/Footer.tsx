...
import Logo from './Logo'; // Uses your real logo.png
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="text-neutral-light/60 text-sm leading-relaxed mb-8 max-w-sm">
              A hybrid creative + technical agency building products, brands, and systems 
              that scale. We blend intelligence and methodology to deliver future-proof 
              digital solutions.
            </p>
            ...
            <div className="flex space-x-4">
              <a
                ...
                text-neutral-light/70 hover:bg-accent hover:text-primary transition-all duration-300"
              >
                <Linkedin size={18}/>
              </a>
          ...
          <div className="lg:col-span-7">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
              {solutions.map((item) => (
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-accent/50 mr-2 opacity-0 group-hover:opacity-100 transition-opacity"/>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <Link to="#" className="text-neutral-light/40 hover:text-white text-xs transition-colors">
              Privacy Policy
            </Link>
